...
const specs = [
  ...
  },
  {
    ...
    label: "Daily Plays",
    value: "40 Times",
    detail: "Per advertisement per day",
    accent: "#FFD400",
  },
  {
    icon: Lightbulb,
    label: "Brightness",
    value: "5000+ Nits",
    detail: "Vivid in all lighting conditions",
    accent: "#0057D9",
  },
  {
    icon: Building2,
    ...
    value: "All Sizes",
    detail: "Ideal for any type of business",
    accent: "#FFD400",
  },
];
            ...
            >
              ...
              <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-gray-700">
                ...
                <div className="m-3 bg-black rounded-xl overflow-hidden relative" style={{ aspectRatio: "10/7" }}>
                  ...
                  {/* Brightness bloom */}
                  <div className="absolute -inset-4 bg-[#0057D9]/20 blur-xl rounded-full animate-pulse-glow" />
                </div>

                {/* Billboard base strip */}
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ 
                    y: -5,
                    scale: 1.02,
                    boxShadow: "0 20px 40px -10px rgba(0,87,217,0.12)"
                  }}
                ...
                >
                  <motion.div
                    ...
                    className="w-11 h-11 rounded-xl flex items-center justify-center mb-4 transition-all shadow-inner"
                  ...
                  <div className="font-heading font-extrabold text-xl text-gray-900 mb-1 tracking-tight">
                    {spec.value}
                  </div>
