      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-heading font-bold text-4xl lg:text-5xl text-gray-900 mb-6">
            Ethiopia&apos;s Premier{" "}
            <span className="text-[#0057D9]">LED Billboard</span> Operator
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* <p className="text-gray-600 text-lg leading-relaxed mb-8">
              AWLO Advertising is an Ethiopian company specializing exclusively in
              digital LED billboard advertising. We own and operate a large, state-of-the-art
              LED billboard that brings businesses to life with vivid, dynamic displays
              that no passerby can ignore.
            </p> */}
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="bg-[#F8FAFC] rounded-2xl p-5 border border-gray-100">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  To empower Ethiopian businesses with premium outdoor advertising that
                  delivers measurable impact and brand visibility.
                </p>
              </div>
              <div className="bg-[#F8FAFC] rounded-2xl p-5 border border-gray-100">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  To become Ethiopia&apos;s most trusted and innovative outdoor digital
                  advertising partner, helping brands achieve impossible visibility.
                </p>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {reasons.map((reason, i) => (
                ...
                >
                  <CheckCircle2
                    size={18}
                    className="text-[#0057D9] mt-0.5 flex-shrink-0"
                  />
